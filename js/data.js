...
window.SITE_I18N = {
  ua: {
    ...
    "about.intro": "Автор, контент-мейкер і людина за кадром. Повна історія, факти та проєкти з’являться тут найближчим часом.",
    "about.note": "Розділ наповнюється",
  ...
  ru: {
    ...
    "about.intro": "Автор, контент-мейкер и человек за кадром. Полная история, факты и проекты появятся здесь в ближайшее время.",
    "about.note": "Раздел наполняется",
    "hero.alt": "Портрет LEHA NEPLOXO",
  ...
  en: {
    ...
    "about.intro": "Author, content creator and the person behind the camera. The full story, facts and projects will land here soon.",
    "about.note": "Section in progress",
